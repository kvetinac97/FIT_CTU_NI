#define BOOST_TEST_MODULE assignment1_test
...
BOOST_AUTO_TEST_CASE(capacity_allocation)
{
...

   {
      ...
      BOOST_TEST_WARN( X::counter(X::DEFAULT_CONSTRUCTED) == 1 );
      ...
      BOOST_TEST_WARN( X::counter(X::DEFAULT_CONSTRUCTED) == 8 );
      BOOST_TEST_WARN( X::counter(X::DESTRUCTED) == 1 );
   ...
   BOOST_TEST_WARN( X::counter(X::CONSTRUCTED) == X::counter(X::DEFAULT_CONSTRUCTED) );
...
BOOST_AUTO_TEST_CASE(insertion_with_preallocation)
{
...

   {
      ...
      BOOST_TEST_WARN( X::counter(X::COPY_ASSIGNED) == 3 );
   }
...
BOOST_AUTO_TEST_CASE(reallocation)
{
...

   {
      ...
      BOOST_TEST_WARN( X::counter(X::COPY_ASSIGNED) == 6 );
...
BOOST_AUTO_TEST_CASE(special_members_insertion)
{
...

   {
      ...
      BOOST_TEST_WARN( X::counter(X::DEFAULT_CONSTRUCTED) == 10 );
      BOOST_TEST_WARN( X::counter(X::INT_CONSTRUCTED) == 4 );
      BOOST_TEST_WARN( X::counter(X::COPY_CONSTRUCTED) == 0 );
      BOOST_TEST_WARN( X::counter(X::COPY_ASSIGNED) == 8 );
   }
...
BOOST_AUTO_TEST_CASE(pop_back)
{
...

   {
      ...
      BOOST_TEST( v[0] == 1 );
      BOOST_TEST( v[1] == 2 );
      BOOST_TEST( X::counter(X::DESTRUCTED) == destructed );
...
BOOST_AUTO_TEST_CASE(copy_constructor)
{
...

   {
      ...
      BOOST_TEST_WARN( X::counter(X::COPY_ASSIGNED) == copy_assigned + 3 );
   }
...
BOOST_AUTO_TEST_CASE(reserve_exception)
{
...

   {
      ...
      X::set_exception_counter(X::DEFAULT_CONSTRUCTOR, 2);
